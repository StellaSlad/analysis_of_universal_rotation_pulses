...
def plot_transfer_efficiency(name: str, offsets: np.ndarray):
    ...
    plt.tight_layout()
    plt.savefig(f'../images/transfer_efficiency_{name}.jpg')
    plt.savefig(f'../images/transfer_efficiency_{name}.pdf')
...
def plot_rotation_axis(name: str, offsets: np.ndarray, rx: list, ry: list, rz: list, Lxx: list, Lyy: list, Lzz: list):
    ...
    plt.savefig(f'../images/rotation_axis_{name}.jpg')
    plt.savefig(f'../images/rotation_axis_{name}.pdf')